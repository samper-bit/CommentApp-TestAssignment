...
internal class InitialData
{
    public static IEnumerable<Comment> CommentsWithAttachedFiles
    {
        get
        {
            ...
            var imageFile = File.Create(FileId.Of(new Guid("5334c996-8457-4cf0-815c-ed2b77c4ff61")), CommentId.Of(new Guid("20e8daea-3f42-4c21-80f1-c6b7c7aaa542")), ".jpg");
            ...
            var textFile = File.Create(FileId.Of(new Guid("c67d6323-e8b1-4bdf-9a75-b0d0d2e7e914")), CommentId.Of(new Guid("eec28f1d-8e6f-4b0d-bc69-aaf765db6975")), ".txt");
