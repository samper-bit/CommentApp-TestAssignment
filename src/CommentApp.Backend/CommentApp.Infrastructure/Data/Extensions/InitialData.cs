...
internal class InitialData
{
    public static IEnumerable<Comment> CommentsWithAttachedFiles
    {
        get
        {
            // Define assembly and files path
            var assemblyPath = Path.GetDirectoryName(Assembly.GetExecutingAssembly().Location);
            var filesPath = Path.Combine(assemblyPath!, "Files");
            ...
            var imageFile = File.Create(FileId.Of(new Guid("5334c996-8457-4cf0-815c-ed2b77c4ff61")), CommentId.Of(new Guid("20e8daea-3f42-4c21-80f1-c6b7c7aaa542")), Path.Combine(filesPath, "5334c996-8457-4cf0-815c-ed2b77c4ff61.jpg"), FileType.Image);
            ...
            var textFile = File.Create(FileId.Of(new Guid("c67d6323-e8b1-4bdf-9a75-b0d0d2e7e914")), CommentId.Of(new Guid("eec28f1d-8e6f-4b0d-bc69-aaf765db6975")), Path.Combine(filesPath, "5334c996-8457-4cf0-815c-ed2b77c4ff61.jpg"), FileType.Text);
